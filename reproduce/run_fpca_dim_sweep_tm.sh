...
# Main output root for FPCA dim sweep.
RUNS_ROOT="${RUNS_ROOT:-${REPO_ROOT}/result_out/fpca_dim_sweep_tm_outputs}"
OUT_ROOT="${OUT_ROOT:-${RUNS_ROOT}}"

DATA_DIR="${DATA_DIR:-${REPO_ROOT}/data/mf_sweep_datasets_nano_tm/hf100_lfx10}"

SWEEP_SCRIPT="${SWEEP_SCRIPT:-${CODE_ROOT}/fpca/fpca_dim_sweep_tm_with_seeds.py}"
TRAIN_SCRIPT="${TRAIN_SCRIPT:-${CODE_ROOT}/fpca/mf_train_nano_tm_dim_sweep.py}"
PLOT_SCRIPT="${PLOT_SCRIPT:-${CODE_ROOT}/fpca/plot_fpca_dim_sweep_tm.py}"
