...
def main(argv: Optional[Sequence[str]] = None, defaults: Optional[TrainDefaults] = None):
    ...
    timing: Dict[str, Any] = {
        ...
        "inference_s": {
            ...
            "mf_oracle_val_test": None,
            "mf_student_val_test": None,
        },
...
# standardize u separately for oracle/student (keeps previous behavior)
    ...
    if int(args.run_oracle) == 1:
        ...
        timing["stage2_train_s"]["mf_oracle"] = _toc(_t_stage2_or, device)
    ...
    if int(args.run_student) == 1:
        ...
        timing["stage2_train_s"]["mf_student"] = _toc(_t_stage2_st, device)
    ...
    if svgp_or is None:
        ...
        timing["inference_s"]["mf_oracle_val_test"] = _toc(_t_infer_or, device)
    ...
    if "_t_infer_st" in locals():
        timing["inference_s"]["mf_student_val_test"] = _toc(_t_infer_st, device)
    ...
    timing["n_lf_train_total"] = int(X_lf_tr_all.shape[0])
    timing["n_lf_val_total"] = int(X_lf_va_all.shape[0])
    timing["n_lf_test_total"] = int(X_lf_te_all.shape[0])
