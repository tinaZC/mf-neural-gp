...
"""
Publication-style TM RMSE sweep from the frozen formal 20-seed analysis.
...
def main() -> None:
    ...
    data_csv = OUT_DIR / "fig_tm_rmse_sweep_data.csv"
    ...
    out_png = OUT_DIR / "fig_tm_rmse_sweep.png"
    out_pdf = OUT_DIR / "fig_tm_rmse_sweep.pdf"
    manuscript_png = OUT_DIR / "_fig_tm_rmse_sweep.png"
    manuscript_pdf = OUT_DIR / "_fig_tm_rmse_sweep.pdf"
