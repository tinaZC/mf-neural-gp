...
# -*- coding: utf-8 -*-
"""
Sweep runner for nanophotonic TM baselines.

Direct call chain:
  sweep -> mf_train_baseline/mf_baseline.py -> mf_train_baseline/mf_train.py

Compared with the old wrapper-based sweep, this version:
- calls the shared baseline directly
- passes --run_prefix explicitly
- passes --ours_train_script explicitly (shared mf_train.py)
- resolves all default paths relative to this script file, not the current cwd
"""
...
def main() -> None:
    ...
    ap.add_argument("--data_root", type=str, default=str(PROJECT_ROOT / "data/mf_sweep_datasets_nano_tm"))
    ap.add_argument("--out_root", type=str, default=str(PROJECT_ROOT / "result_out/mf_sweep_runs_baseline_nano_tm"))
    ...
    ap.add_argument("--run_prefix", type=str, default="bl0")
