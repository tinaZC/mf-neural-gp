...
DEFAULT_OUT_DIR = str(SCRIPT_DIR / "../../result_out/mf_train_nano_ab")
# =========================
...
def build_run_name(args: argparse.Namespace) -> str:
    ...
    fall back to a stable hashed short name: ab0 + 7 hex chars.
    """
    import hashlib
    ...
    payload = {
        ...
        "lf_prob": int(getattr(args, "lf_prob", 0)),
        "mf_student_lf_source": str(getattr(args, "mf_student_lf_source", "student")),
        "seed": int(args.seed),
    }
    digest = hashlib.md5(json.dumps(payload, sort_keys=True).encode("utf-8")).hexdigest()[:7]
    return f"ab0{digest}"
